 ...
 * @author LENOVO
 */
@WebServlet(name = "ShowtimeAPI", urlPatterns = {"/api/showtime/*"})
public class ShowtimeAPI extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Showtime> showtimes = showtimeDAO.getShowtimeByMovieId(movieId);
        ...
        if (!showtimes.isEmpty()) {
            ...
            Gson gson = new Gson();
            response.getWriter().write(gson.toJson(showtimes));
